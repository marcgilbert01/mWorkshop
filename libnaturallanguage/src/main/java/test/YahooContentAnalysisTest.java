...
public class YahooContentAnalysisTest {
    ...
    public void testGetKeywords(){
        ...
        String[] keywords = yahooContentAnalysis.getKeywords("A senior coroner has called for a national review of police use of restraints after an inquest jury found a decision to restrain a 57-year-old man suffering from lung cancer and pneumonia in hospital contributed to his death.\n" +
                "\n" +
